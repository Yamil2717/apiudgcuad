...
export const createUserValidation = object({
    body: object({
        ...
        rePassword: string().oneOf([ref('password'), null], 'Las contraseñas no coinciden.').required('Debe ingresar la confirmación de la contraseña'),
        ...
        userType: number().required('Debe ingresar un tipo de usuario.').typeError('Debe ingresar un tipo de usuario'),
